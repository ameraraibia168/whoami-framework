...
info = {
        "name"        : "flight_radar_24",
        "title"       : "View any world plant",
        "module"      : "network/info/gui/flight_radar_24",
        "description" : """
  the radar stations in the world."""
}
...
def running():
    try:
            print ('')
            print (blue+"[*]"+default+"starting the radar")
            time.sleep(0.01)
            try:
                ...
                class Window(QMainWindow):
                    ...
                    def __init__(self):
                        ...
                        self.browser.setUrl(QUrl('https://www.flightradar24.com'))
                ...
                QApplication.setApplicationName('Radar')
